...
\usepackage[base=base_alternative_h&s.pdf,alt]{dndcharactersheet}
...
\begin{document}
	...
	\DndCharacterSheet{
		...
		OtherProficiencies={
			...
			\\
			Languages: Common, Netherese, Sylvan, Thieves' Cant\\
		},
		Armor=17,
		Speed=10,
		Hitpoints={
		...
		Flaws={
			...
			When angry, you can only bring yourself to speak Netherese.
		},
		Features={
			Fey\\
...
%You have a knack for making your way in the deep places of the world. You can recall the twists and turns of passageway‘ and tunnels such that you can always retrace your steps underground. You're also well acquainted with foraging and survival in the Underdark, and can determine when sources of food and water are safe to consume. You can always find sufficient food and water for yourself and up to five other people in the Underdark, as long as sustenance is available in the area.
	...
	\DndDetailsSheet{
		...
		Appearance={
			...
			She carries a moldy shield she found in the Shadowfell on the battlefield of Bestburg and engraved it with Naralis Analors white dove. For ranged combat she wields a miniaturized shortbow and for close combat a dagger, which appears more like a shortsword relative to her size.
		},
		Backstory={
			As an ancient pixie I do not recall my exact age, but I'm at least several hundred years old. I also do not remember my true home, I only imagine it to be a place of peace and joy. For decades though I was impisoned under the cruel pirate captain Webster 'Splinter' Salvotor.
		...
		Traits={
			...
			Right={
				%Zinlee does not remember, but she once lived on the Moonshea Isles. She and her brothers and sisters used to travel between the material plane and the feywild all the time. Back then pixies and elves lived in harmony. They traded and the elves protected the pixies from preditors (and humans). They shared tradition and culture (aka pixies know elven gods). It was not uncommon for pixies to form an empathic bond with a specific elf they grew fond of. However, whenever such an elf died, the pixie passed away from sadness of the loss. It was called the "blessing of Naralis Analor". Most pixies were not bothered by this. Elves were blessed with very long lives, so a pixie usually would not mourn its lost eternity. They saw it as a blessing - hence the name, since they did not have to go on living after a dear friend and a soul mate had past away. Zinlee however was afraid of dying. She avoided elves most of her live, since she did not want to get to close to any mortal creature.
			}
		},
		Treasure={
			Left={

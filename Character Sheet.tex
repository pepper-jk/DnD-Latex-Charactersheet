...
\begin{document}
	...
	\DndCharacterSheet{
		...
		Money={
			...
			Silver=0,
			Electrum=0,
			Gold=108, %starting: 110gp, payment: 120gp, loot: 50gp
			Platin=0,
		},
		Equipment={
			Wooden Staff, Ruby of the War Mage,\\
			2 Longbow, Quiver, 97 Arrows, 2 Dagger\\
			Studded Leather Armor, Scale Mail\\
			2 Travelers Clothes, Backpack, Waterskin, 5 Rations, 5 Chalk, 5 Torches,\\
